...
export function createBaranTemplate() {
  return {
    ...
    stages: {
      mindMap: {
        nodes: [
          { id: 'root', x: 400, y: 270, text: 'BARAN', type: 'root' },
          { id: 'n1', x: 190, y: 140, text: 'Inspiration', type: 'branch' },
          { id: 'n2', x: 610, y: 140, text: 'Materials', type: 'branch' },
          { id: 'n3', x: 190, y: 400, text: 'Silhouette', type: 'branch' },
          { id: 'n4', x: 610, y: 400, text: 'Colour Story', type: 'branch' },
          { id: 'n5', x: 50, y: 60, text: 'Rain / Storm', type: 'leaf' },
          { id: 'n6', x: 210, y: 40, text: 'Architecture', type: 'leaf' },
          { id: 'n7', x: 510, y: 55, text: 'Technical Fabrics', type: 'leaf' },
          { id: 'n8', x: 700, y: 55, text: 'Wool Blends', type: 'leaf' },
          { id: 'n9', x: 55, y: 460, text: 'Oversized', type: 'leaf' },
          { id: 'n10', x: 215, y: 480, text: 'Structured', type: 'leaf' },
          { id: 'n11', x: 510, y: 465, text: 'Storm Grey', type: 'leaf' },
          { id: 'n12', x: 700, y: 465, text: 'Navy / Slate', type: 'leaf' },
        ],
        edges: [
